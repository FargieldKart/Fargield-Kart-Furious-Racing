...
# ***<ins>Download the new Fargield Kart installer, which is faster and easier than the manual install:</ins> https://github.com/FargieldKart/Fargield-Kart-Furious-Racing/releases/tag/v1.02***
